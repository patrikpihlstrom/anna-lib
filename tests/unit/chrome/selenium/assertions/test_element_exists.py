...
class ElementExists(unittest.TestCase):
	...
	def test_passed(self):
		...
		self.assertTrue(assertions.element_exists(self.driver, 'a[href="http://annahub.se:8000/test/switchto"]', timeout=0)['passed'])
		self.assertTrue(assertions.element_exists(self.driver, '$cssa[href="http://annahub.se:8000/test/switchto"]', timeout=0)['passed'])
